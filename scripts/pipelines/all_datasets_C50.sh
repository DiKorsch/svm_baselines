...
export SVM_OUTPUT=${SVM_FOLDER}/.results2
...
for NAME in CUB200 NAB FLOWERS CARS ; do
	...
	OPTS="--input_size 427 --label_shift ${label_shift} --prepare_type model"
